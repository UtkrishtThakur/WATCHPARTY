import "@/models/User";       // force User model to register before any route uses populate()
import "@/models/Room";       // ensure Room model loads after User

/**
 * File: lib/db.js
 * Purpose: MongoDB connection handler - manages connection, normalizes MONGO_URI, provides helpful error messages
 */
